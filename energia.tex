...
En el caso del ejemplo asociado a la figura~\ref{fig:poleaideale}, si consideremos que entre las dos superficies fricción, esta realiza un trabajo que se disipa en calor $Q$, a medida que el cuerpo de masa $m_1$ cae una distancia $y_0$ dado por
\begin{align*}
...
%\only<2>{\includegraphics[scale=0.5]{resorte2}}%
%\only<3>{\includegraphics[scale=0.5]{resorte3}}%
...
\item Un anillo resbala a lo largo de un arco metalico ABC muy pulido que es arco de una circunferencia de radio $R=1.2\meter$. Sobre el anillo actúa una fuerza $\mathbf{F}$ de magnitud $150\newton$ y dirección constante formando un ángulo de $\alpha=\pi/6$ con la horizontal. 
