...
\includecomment{onlybeamer}
\specialcomment{onlybeamer}
{\begingroup}{\endgroup}
%\excludecomment{onlybeamer}
...
\newcommand{\finejemplo}{\hfill\rule{1ex}{1ex}}
...
%\mode<presentation>{\input{introduccion}}
%\mode<presentation>{\input{preliminares}}
%\mode<presentation>{\input{intermov}}
%\mode<presentation>{\input{dinamica}}
%\mode<presentation>{\input{momentum}}
%%\mode<presentation>{\input{cinematica}}
\mode<presentation>{\input{energia}}
%\mode<presentation>{\input{rigido}}
%\mode<presentation>{\input{centrales}}
%\mode<presentation>{\input{oscilador}}
%\mode<presentation>{\input{relatividad}}
