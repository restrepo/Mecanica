...
\end{align}
donde hemos definido la \emph{frecuencia característica} del oscilador armónico como
\begin{align*}
...
\end{align*}
La amplitud de oscilación $A(\omega)$ es máxima, de hecho infinita, cuando $\omega\to \omega_0$ %como se muestra en la figura
