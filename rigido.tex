...
Por conservación de la energía, si $m$ cae una distancia $h$ y tomando el origen del sistema de referencia en la altura final
\begin{align}
  mgh=&\frac{1}{2}I_{C}\omega^2+\frac{1}{2}mv^2 \nonumber\\
  mgh=&\frac{1}{2}I_{C}\left( \frac{v}{2R} \right)^2+\frac{1}{2}mv^2 \,.
\end{align}
Obteniendo la misma expresión
