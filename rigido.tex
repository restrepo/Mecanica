...
respecto al centro de masa y $\mathbf{L}_{\text{ext}}$ es moméntum angular
ocasionado por las fuerzas externas al cuerpo rígido
\item
  \begin{align*}
    \sum_{i=1}^N\mathbf{r}_i'\times m_i \dot{\mathbf{R}}=0\,.
  \end{align*}
\item
  \begin{align*}
...
\begin{align}
  \label{eq:lcm}
   \mathbf{L}=&\mathbf{L}_{\text{ext}}+\mathbf{L}_0\nonumber\\
